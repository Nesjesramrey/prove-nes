...
export class AddDocumentTestimonyComponent implements OnInit {
  ...
  createTestimony() {
    ...
    if (this.fileNames.length == 0) {
      ...
      let data = {
        files: this.addTestimonyFormGroup.controls['files']['value'],
        name: this.addTestimonyFormGroup.value.name,
        description: this.addTestimonyFormGroup.value.description,
