...
@Component({
  selector: 'set-avatar-association',
  templateUrl: './set-avatar-association.component.html',
  styleUrls: ['./set-avatar-association.component.scss'],
  providers: [StyleRenderer]
})
export class SetAvatarAssociationComponent implements OnInit, WithStyles, AfterViewInit {
  ...
  uploadAvatarImage() {
    ...
    let data: any = {
      association_id: '63e55f1bdaf69388e76f6f41',
      formData: new FormData()
    };

    data['formData'].append('file', file, 'avatar.jpg');

    this.associationService.uploadAvatarImageEndPoint(data).subscribe((reply: any) => {
